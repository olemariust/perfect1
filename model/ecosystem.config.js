// pm2 process definition for poker44-cetus (D0Cetus).
...
const PORT = E.POKER44_AXON_PORT || "8100";
const NETWORK = E.POKER44_SUBTENSOR_NETWORK || "finney";
const NAME = E.POKER44_PM2_NAME || "p44d0-cetus";
if (!WALLET || !HOTKEY) {
  throw new Error("poker44-cetus: missing POKER44_WALLET_NAME / POKER44_WALLET_HOTKEY in .env");
}
