"""poker44-cetus — Poker44 (SN126) bot-detection miner entrypoint.

Serves the D0Cetus detector and attaches a model manifest (repo, commit,
...
def build_manifest(meta, artifact_name):
    ...
    return build_local_model_manifest(
        ...
        defaults={
            "model_name": "poker44-cetus",
            "model_version": "3.10",
            "framework": "weighted-rank d0-blend 0.36/0.2/0.24/0.2: stack(lgb60lv,et510d17,rf410d11,cv6) + mono-xgb2(d4) + pca40-mlp3(88, 44) + drse(n9,ff0.78)",
            "license": "MIT",
            "repo_url": repo_url,
            "repo_commit": _repo_commit(),
            "artifact_sha256": artifact_sha256(),
            "notes": ("Weighted 4-member rank-blend at 0.36/0.2/0.24/0.2: a 60-leaf benchmark-supervised stack (cv6) and a 2-seed depth-4 monotone XGBoost on the behavioral view, a 3-seed PCA-40 MLP (88, 44) committee on the union view, and a drift-robust subspace ensemble (n=9, feature-fraction 0.78) on the v2 view. "
...
class MLMiner(BaseMinerNeuron):
    """poker44-cetus: weighted-rank d0-blend 0.36/0.2/0.24/0.2: stack(lgb60lv,et510d17,rf410d11,cv6) + mono-xgb2(d4) + pca40-mlp3(88, 44) + drse(n9,ff0.78)."""
    ...
    def __init__(self, config=None):
        ...
        bt.logging.info(
            f"poker44-cetus ready | cv_ap={meta.get('cv_ap', 0.0):.4f} "
    ...
    async def forward(self, synapse: DetectionSynapse) -> DetectionSynapse:
        ...
        record_synapse(synapse, miner="poker44-cetus")
        return synapse
...
if __name__ == "__main__":
    with MLMiner() as miner:
        bt.logging.info("poker44-cetus miner running...")
        while True:
            try:
                bt.logging.info(
