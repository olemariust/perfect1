"""poker44-cetus — D0Cetus: weighted 4-member rank-blend on three feature views.
...
Weighted 4-member rank-blend at 0.36/0.2/0.24/0.2: a 60-leaf benchmark-supervised stack (cv6) and a 2-seed depth-4 monotone XGBoost on the behavioral view, a 3-seed PCA-40 MLP (88, 44) committee on the union view, and a drift-robust subspace ensemble (n=9, feature-fraction 0.78) on the v2 view.
"""
import numpy as np

# per-variant blend weights chosen at spec time (walk-forward verified)
W = {"stack": 0.36, "mono": 0.2, "mlp": 0.24, "drse": 0.2}
