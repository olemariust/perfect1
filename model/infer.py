"""Self-contained inference for poker44-cetus (D0Cetus).
...
from d0_ensemble import D0Cetus  # noqa: F401  (needed to unpickle the artifact)
...
_ARTIFACT = os.environ.get("POKER44_ARTIFACT", "d0_cetus_v310.pkl")
_MAX_POS_FRAC = float(os.environ.get("POKER44_MAX_POS_FRAC", "0.12"))
